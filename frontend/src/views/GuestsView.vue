        ...
        <div v-else>
                ...
                <div class="text-sm text-gray-600 space-y-1">
                  <div v-if="guest.phone">
                    ...
                    >
                      ...
                      <span class="font-mono">{{ guest.phone }}</span>
                    </a>
                  </div>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="guest in guests" :key="guest.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4">
                <div v-if="guest.phone" class="mb-0.5">
                  <a
                    :href="formatWaLink(guest.phone)"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div v-if="guest.email" class="text-xs text-gray-500">{{ guest.email }}</div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">

            ...
            <div class="space-y-3">
              ...
              <div class="text-sm space-y-1">
                <div>
                  ...
                  <span class="text-gray-900 ml-1 font-semibold">{{ booking.customer_name }}</span>
                </div>
                <div v-if="booking.customer_phone" class="mt-0.5">
                  <a
                    :href="formatWaLink(booking.customer_phone)"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-flex items-center gap-1.5 text-xs text-emerald-700 hover:text-emerald-800 font-medium hover:underline bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200/80"
                  ...
                  >
                    ...
                    <span class="font-mono">{{ booking.customer_phone }}</span>
                  </a>
                </div>
                <div v-if="booking.customer_email" class="text-xs text-gray-500">{{ booking.customer_email }}</div>
                <div>
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <div v-if="viewData.customer_phone" class="mt-0.5">
                  <a
                    :href="formatWaLink(viewData.customer_phone)"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    ...
                    <span class="font-mono">{{ viewData.customer_phone }}</span>
                  </a>
                </div>
